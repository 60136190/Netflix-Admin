...
import com.example.adminnetflix.activities.DetailBillActivity;
import com.example.adminnetflix.models.response.HistoryBill;
...
public class ListHistoryBillAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (history.getFilm().getImageFilm().getUrl()!=null){
